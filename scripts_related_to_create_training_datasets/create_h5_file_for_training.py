...
path = "/n/holylfs05/LABS/arguelles_delgado_lab/Everyone/hhanif/tambo_simulations_for_training/combined_electrons.h5"
out_path = "/n/holylfs05/LABS/arguelles_delgado_lab/Everyone/hhanif/tambo_simulations_for_training/combined_electrons_balanced_v2.h5"
NUM_OF_SHOWERS = 2000
...
with h5py.File(path, 'r') as f:
    ...
    with h5py.File(out_path, 'w') as out:
        ...
        out.create_dataset('shape', data=np.array([total, NUM_OF_SHOWERS, 5], dtype=np.int64))
